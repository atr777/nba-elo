...
*LeBron picked Philadelphia. Our roster model moves the Sixers up 45 points, to 12th, and the names outrun the forecast.*
...
Start with the man himself. Our system watched LeBron rise from league average as a rookie to a peak around 2013, and it has watched him glide down since. He is a 1,844 today, 13th in the league. That is still a very good player, better than all but a dozen others, and it is also a long way from the number he posted at 28.

![LeBron's rating across 23 seasons](assets/lebron_career_arc_2026.png)

That glide is the reason the forecast stays calm. Here is what the roster model does. It takes every team's rating from the end of last season, pulls it partway back toward league average (1500), because one season is a small sample and rosters turn over, and then it adds the talent a team gained or lost this summer. That talent is measured in player-rating points and kept zero-sum across the league, so nobody's gain is invented.

The Sixers gain 45 of those points. That is a top-three move this offseason, trailing only Washington and level with Portland. It lifts Philadelphia from a team that finished last year at 1486, below the league line, to a preseason 1530. In the full table that is 12th.

![How the Sixers' 2026-27 forecast changed](assets/sixers_roster_move_2026.png)

Twelfth is not where the marquee wants to be. But look at where they started. Philadelphia finished last season below average, and a summer of star names does not erase a season of results in our system, it sits on top of them. Add a 41-year-old LeBron and Jaylen Brown to a middling base and you get a good team with real questions, not a coronation. The model prices the health of a player in his 23rd season, and a center who has missed time, the way an actuary would, without sentiment.

The other side of the ledger is in Los Angeles. The Lakers lose 76 points, the steepest fall of any team this summer except the Clippers, and drop to 1481, 19th. That is what losing your best forecast-mover looks like when you do not replace him.

For scale, the model still has Oklahoma City on top at 1631, then San Antonio and Boston. Philadelphia sits closer to the middle of the league than to that group. LeBron chose the team he believes gives him the best chance at a title. Our numbers say he improved a contender's odds without becoming the favorite, which is a fair description of what one 41-year-old can still do.
