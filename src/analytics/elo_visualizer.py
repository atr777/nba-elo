...
class ELOVisualizer:
    ...
    def __init__(self, elo_data_path: str, output_dir: str = "data/exports/visualizations"):
        """
        Initialize visualizer with ELO data.
        
        Args:
            elo_data_path: Path to ELO history CSV
...
def create_sample_visualizations():
    ...
    if Path("data/exports/team_elo_with_travel.csv").exists():
        viz.plot_travel_impact("data/exports/team_elo_with_travel.csv")
    else:
